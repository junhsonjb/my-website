...
/* Trying to see if I can use express to serve up an html file with emojis */
// function emojiRunner(request, response) {
//
//   /* Server Code here */
//   //old server code (WITHOUT EXPRESS)
//   // response.writeHead(200, {"Content-Type" : "text/html"});
//   // fs.createReadStream("./index.html").pipe(response);
//
//   const index = "./introduction-emoji.html";
//   fs.readFile(index, function(err, data) {
//     response.contentType("text/html");
//     response.send(data);
//   });
//
//   // response.send("Cool, dude!");
//
//
// }
...
app.get('/', runner);
// app.get('/emoji', emojiRunner); //doesn't work
